...
public class CommunityController {
	...
	public String noticeBoard(@ModelAttribute("AdminInfo") AdminInfo adminInfo, BindingResult result, Model model){
	...
	public String faqBoard(@ModelAttribute("AdminInfo") AdminInfo adminInfo, BindingResult result, Model model){
	...
	public String faqWrite(@ModelAttribute("AdminInfo") AdminInfo adminInfo, BindingResult result, Model model){
		BoardSrchInfo boardSrchInfo = new BoardSrchInfo();
