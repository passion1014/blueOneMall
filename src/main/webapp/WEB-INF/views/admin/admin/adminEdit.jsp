		...
		<table>
			...
			<tr>
				...
				<td colspan="3" style="padding:5px 5px 5px 10px;" class="left">
					...
					<input type="checkbox" id="g2" name="grade" value="g2" <c:if test="${info.gd[1] eq 'g2'}" >checked</c:if> /> 메인관리 &nbsp;&nbsp;
					<input type="checkbox" id="g3" name="grade" value="g3" <c:if test="${info.gd[2] eq 'g3'}" >checked</c:if> /> 회원관리 &nbsp;&nbsp;
					<input type="checkbox" id="g4" name="grade" value="g4" <c:if test="${info.gd[3] eq 'g4'}" >checked</c:if> /> 상품관리 &nbsp;&nbsp;
					<input type="checkbox" id="g5" name="grade" value="g5" <c:if test="${info.gd[4] eq 'g5'}" >checked</c:if> /> 주문관리 &nbsp;&nbsp;
					<input type="checkbox" id="g6" name="grade" value="g6" <c:if test="${info.gd[5] eq 'g6'}" >checked</c:if> /> 커뮤니티
				</td>
			</tr>
			<tr>
				<th>추가관리정보</th>
