				...
				<td class="left">
					<div style="margin-top:5px;">
						<b>가입날짜검색</b> <input type="checkbox" id="schChkDate" name="schChkDate" value="Y" onClick="dateDisable();" <?=$_checked?>> &nbsp;&nbsp;
							<input type="text" name="schReqSDate" id="schReqSDate" readonly value="" class="Text Kor" style="width:65px;" <?=$_disabled?>일 부터
							<input type="text" name="schReqEDate" id="schReqEDate" readonly value="" class="Text Kor" style="width:65px;" <?=$_disabled?>일 까지 &nbsp;&nbsp;
					</div>
