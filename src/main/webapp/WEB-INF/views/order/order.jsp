...
<body onload="init_orderid();">
	...
	<div class="container">
		...
		<div class="sub_content">
			...
			<input type="hidden" name="reciAdd"  id="reciAdd"  value="document.getElementById('custZip1').value+document.getElementById('custZip2').value+document.getElementById('custAdd').value+document.getElementById('reciAdd4').value;" />
